...
const icons = [
  { Icon: CinematicCameraIcon, style: { top: '15%', left: '10%', animationDelay: '0s', animationDuration: '10s' }, size: 100 },
  { Icon: Computer, style: { top: '20%', left: '80%', animationDelay: '2s', animationDuration: '12s' }, size: 45 },
  { Icon: CinematicCameraIcon, style: { top: '70%', left: '5%', animationDelay: '4s', animationDuration: '9s' }, size: 120 },
  { Icon: Computer, style: { top: '80%', left: '90%', animationDelay: '1s', animationDuration: '14s' }, size: 35 },
  { Icon: CinematicCameraIcon, style: { top: '50%', left: '50%', animationDelay: '3s', animationDuration: '8s' }, size: 85 },
